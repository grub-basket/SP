...
export class StashpadSettingTab extends PluginSettingTab {
  ...
  > {
    ...
    cats.composerCopy.push(toggle("Auto-pair Markdown syntax", "Brackets, parentheses, inline code, **bold**, ~~strikethrough~~ and ==highlight== markers auto-close with the caret between them; typing the closing character steps over an existing one, and Backspace on an empty pair removes both. Applies to the composer and the edit/split textareas. On by default.",
